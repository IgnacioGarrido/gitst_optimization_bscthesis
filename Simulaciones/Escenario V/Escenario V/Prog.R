...
coche_inv <- read.delim("~/Universidad/4/SegundoSemestre/TFG/___AuxiliarParaToquetearSinCagarla/Resultados simulaciones/Escenario V/coche_inv.txt", header = F, sep = "\t")   
coche_pri <- read.delim("~/Universidad/4/SegundoSemestre/TFG/___AuxiliarParaToquetearSinCagarla/Resultados simulaciones/Escenario V/coche_pri.txt", header = F, sep = "\t")   
coche_ver <- read.delim("~/Universidad/4/SegundoSemestre/TFG/___AuxiliarParaToquetearSinCagarla/Resultados simulaciones/Escenario V/coche_ver.txt", header = F, sep = "\t")   
coche_oto <- read.delim("~/Universidad/4/SegundoSemestre/TFG/___AuxiliarParaToquetearSinCagarla/Resultados simulaciones/Escenario V/coche_oto.txt", header = F, sep = "\t")   
...
p <- p+xlab("Hora")+ylab("€")+ggtitle("Gasto/hora de ESCENARIO V")+theme(plot.title = element_text(hjust = 0.5))
