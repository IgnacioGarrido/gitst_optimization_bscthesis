...
$ONTEXT
Esta es la versión 2 del programa final.
El objetivo será añadir a la versión 1 la producción fotovoltáica y una
...
*A la hora de salida pone como valor mínimo de la carga CARGAALASALIDA.
...
EQUATIONS
     ...
     CARGASALIDA(I)      Función que sirve para que el coche nunca esté por debajo de un mínimo
;
