...
LOOP(I, COUNTERLOOP = COUNTERLOOP+1;
        if (COUNTERLOOP >= HORASALIDA, if(CARGAINICIAL > CARGAALASALIDA, CARGA.fx(I) = CARGAINICIAL; else CARGA.fx(I) =  CARGAALASALIDA;); ;);
        if (COUNTERLOOP = 24, COUNTERLOOP = 0;)
;);
...
MODEL progConCoches4 /OBJ, ITERACIONCOCHEACEPTADO, CAPACIDADMAX, CARGAMAX, DESCARGAMAX, CARGALIMITADA, DINEROPOSITIVO, MAXGASTO/ ;
MODEL progConCoches5 /OBJ, ITERACIONCOCHEACEPTADO, CAPACIDADMAX, CARGAMAX, DESCARGAMAX, NODESCARGADEBAJO, CARGALIMITADA, DINEROPOSITIVO, MAXGASTO/ ;
